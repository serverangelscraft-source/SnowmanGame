...
exec(Path("scripts/apply_notifications_v18_5.py").read_text(encoding="utf-8"), {"__name__": "__main__"})
exec(Path("scripts/apply_school_call_fix_v18_6.py").read_text(encoding="utf-8"), {"__name__": "__main__"})
exec(Path("scripts/apply_dinner_scale_v18_10.py").read_text(encoding="utf-8"), {"__name__": "__main__"})
