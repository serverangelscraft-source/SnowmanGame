...
public class ClassOneActivity extends Activity {
    ...
    static class ClassOneView extends View {
        ...
        void drawGrade2(Canvas c){
            ...
            action.set(dp(22),bottom-dp(66),w-dp(22),bottom-dp(11));p.setColor(Color.rgb(213,229,237));c.drawRoundRect(action,dp(20),dp(20),p);text.setTextSize(tx(8));text.setColor(Color.rgb(96,123,136));c.drawText("2-А • НАСТУПНИЙ РОЗДІЛ",action.centerX(),action.centerY()+dp(3),text);
        }
        ...
        @Override public boolean onTouchEvent(MotionEvent e){
            ...
            else if(stage==GRADE2){if(memoryBtn.contains(x,y)){ctx.startActivity(new Intent(ctx,MemoryActivity.class));return true;}if(wardrobeBtn.contains(x,y)){ctx.startActivity(new Intent(ctx,WardrobeActivity.class));return true;}}
            return true;
        }
